...
\addbibresource{/Users/omojumiller/Dropbox/Research/Dissertation/dissertation.bib}
...
\begin{table}[!htbp]
  \begin{center}
    \begin{tabular}{ ll } 
    \multicolumn{2}{ c }%
    {\textbf{Dimensions of Participant's CS Interest}} \\[5pt] 
  
    {\normalsize atcs} & Attitudes about CS competency.\\ 
